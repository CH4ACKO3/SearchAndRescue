        ...
        public static readonly IReadOnlyList<CompatibilityCatalogEntry> Entries =
            new List<CompatibilityCatalogEntry>
            {
                ...
                Entry("EPOE-Forked", "EPOE", CompatibilitySupportLevel.Compatible,
                    null, "vat.epoeforked"),
                Entry("Smart Medicine - Continued (MemeGoddess)", "SmartMedicine", CompatibilitySupportLevel.Compatible,
                    () => Compatibility.UsesSmartMedicine, "memegoddess.smartmedicine"),
                Entry("Smart Medicine - Continued (PES7)", "SmartMedicine", CompatibilitySupportLevel.Compatible,
                    () => Compatibility.UsesSmartMedicine, "pes7.smartmedicinecontinued"),
                ...
                Entry("Dubs Rimkit", "DubsRimkit", CompatibilitySupportLevel.Integration,
                    () => RimkitCompatibility.Ready, "Dubwise.DubsRimkit"),
                ...
                Entry("GrimWorks: Work Manager", "GrimWorks", CompatibilitySupportLevel.Integration,
                    () => GrimWorksCompatibility.Available, "grimworks.workmanager"),
                ...
                Entry("Priority Treatment Ressurected", "PriorityTreatment", CompatibilitySupportLevel.Compatible,
                    () => PriorityTreatmentCompatibility.Ready,
