...
- [Workshop descriptions and text exports](workshop/)
  Workshop copy follows the user's 2026-09-06 revision: retain its existing sections and concise per-mod entries; update those entries in place. Keep implementation and test detail in the development/review records.
