...
**Work Tab — Compatible**
Reads detailed WorkGiver priorities. The new Doctor subtask "provide emergency medical care", together with Field Rescue, allows emergency-only medics while routine tending and surgery remain disabled. Routine care respects humanlike/animal subtasks. Work Tab is optional.
