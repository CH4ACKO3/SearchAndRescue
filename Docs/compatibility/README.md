...
**Biotech — Compatible**
Colony work mechs can participate according to their enabled work types. CE stabilization that depends on human medical skill is assigned to suitable human doctors. Hemogen-pack transfusion is supported. Casualty filtering covers flesh-and-blood beings that use ordinary wound and medical flows.
