...
保留人形救援与俘虏，选药和包扎沿用 Paniel 原生流程。生物急救按种族过滤；完整维修通过床边 PN_Repair 和 PN_RepairKit 完成。源码已核对，种族本体待实机验证。

**Androids for RW 1.6 — 部分兼容**
机械机器人通过原模组选择 ChjDroidRepairParts 并执行 TendPatient；ChjAndroid 保留普通药品。生物急救按种族过滤。完整维修通过原生手术和 ChjDroidRepairKit 完成，种族本体待实机验证。

**Androids Expanded — 部分兼容**
沿用 Androids 的小人与维修接口；扩展种族与特殊能力待实机验证。
